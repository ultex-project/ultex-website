...
export default function QuoteCard({text}: {text: string}) {
    return (
        ...
        >   <img src={"/images/cursor.svg"} className={"inline-block h-10 relative top-[-9px] left-[-7px]"} />
            {text}
            <img src={"/images/cursor.svg"} className={"inline-block rotate-180 h-10 relative top-[9px] left-[0px]"} />
        </p>
