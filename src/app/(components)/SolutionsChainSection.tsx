        ...
        <section className="py-20 bg-[#11131A] text-white" ref={containerRef}>
            <div className="container mx-auto max-w-6xl px-6 xl:px-8">
                ...
                <p className="text-center text-gray-400 max-w-3xl mx-auto mb-12">
                    Découvrez l’ensemble des solutions logistiques et import-export proposées par ULTEX. Une gamme
                    complète de services adaptés à chaque étape de votre chaîne logistique.
                </p>
